...
submitButton.addEventListener("click", function(evt){
    ...
    if(place === "dark"){
        if(textbox.value === "battle it"){
            ...
            }else if (textbox.value === "run away"){
        ...
        if(place === "village"){
            if(/go.*village/.test(textbox.value)){ 
                place = "robbers";
        ...
        }else if(/continue.*journey/.test(textbox.value)){
            place = "next";
    ...
    if(place === "robbers"){
        if(/battle.*theif'?s/.test(textbox.value)){
             place === "battle";
        ...
        }else if(/leave.*knight'?s/.test(textbox.value)){
            place === "lazy";
    ...
    if(place === "battle"){
        if(/fight.*with.*warrior/.test(textbox.value)){
            place = "join";
        ...
        }else if(/will.*battle.*alone/.test(textbox.value)){
    ...
    if(place === "idiot"){
        if(textbox.value === "i will kill this cow for food."){
              questlog.innerHTML += "you killed the cow and got beef.<br>";
        }else if(textbox.value === "i will find another type of animal to kill for food"){
            place = "weird";
        ...
        if(place === "weird"){
            if(textbox.value === "i will eat this odd chicken."){
                place = "water";
            ...
            }else if(textbox.value === "i will find another animal"){
                questlog.innerHTML += "your vision starts to become hazy and blury<br>";
                questlog.innerHTMLn += "you fall over and die. Game Over.<br>";
            }else{
                questlog.innerHTML += "that choice doesn't exist try again.<br>";
            }
        }
        if(place === "water"){
            if(textbox.value === "i will drink the water now."){
                place = "noise";
            ...
            }else if(textbox.value ==="i will drink it in the morning"){
        ...
        if(place === "noise"){
            if(textbox.value === "go into the woods"){
                place = "beast";
                ...
                questlog.innerHTML += "you see a wolf come at you. The wolf groans at you. Do you fight the wolf or run away. "
            }else if(textbox.value === "go back to sleep"){
                place = "run";
            ...
            if(place === "beast"){
                if(textbox.value === "fight the beast"){
            ...
            if(place === "bite"){
                if(textbox.value === "kick the wolf off"){
                    place = "blood_loss";
                ...
                }else if(textbox.value === "shake the wolf off"){
                    place = "werewolf";
